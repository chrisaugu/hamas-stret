...
//    tertiary = Pink80,
    ...
    background = PngBlack,
    onBackground = PngWhite,
    surface = PngEarthBrown,
    onSurface = PngWhite,
    error = PngOchre
)
...
val extendedLightMediumContrast = ExtendedColorScheme(
    ...
    yello = ColorFamily(
        yelloLightMediumContrast,
        onYelloLightMediumContrast,
        yelloContainerLightMediumContrast,
        onYelloContainerLightMediumContrast,
    ),
)
...
val extendedLightHighContrast = ExtendedColorScheme(
    ...
    yello = ColorFamily(
        yelloLightHighContrast,
        onYelloLightHighContrast,
        yelloContainerLightHighContrast,
        onYelloContainerLightHighContrast,
    ),
)
...
val extendedDarkMediumContrast = ExtendedColorScheme(
    ...
    yello = ColorFamily(
        yelloDarkMediumContrast,
        onYelloDarkMediumContrast,
        yelloContainerDarkMediumContrast,
        onYelloContainerDarkMediumContrast,
    ),
)
...
val extendedDarkHighContrast = ExtendedColorScheme(
    ...
    yello = ColorFamily(
        yelloDarkHighContrast,
        onYelloDarkHighContrast,
        yelloContainerDarkHighContrast,
        onYelloContainerDarkHighContrast,
    ),
)
...
//        typography = appTypography, // Define custom PNG-flavored typography if desired
        shapes = PngShapes, // Optional: create rounded tribal-inspired shapes
        content = content
    )
}
